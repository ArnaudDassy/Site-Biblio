...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 28 Avril 2015 à 21:18
...
INSERT INTO `biblio` (`id`, `nom`) VALUES
(1, 'Oreye'),
(3, 'Waremme'),
(4, 'Seraing'),
(5, 'Flémalle'),
...
INSERT INTO `livre` (`id`, `titre`, `auteur_id`, `maison_id`, `note`, `body`, `type_id`, `genre_id`, `biblio_id`) VALUES
